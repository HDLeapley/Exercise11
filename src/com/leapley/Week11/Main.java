...
/*
Hudson Leapley 4/2/2019
##Exercise Modify the WeatherStation example from the lecture notes
to include a PressureSensor class that implements WeatherDataSource
